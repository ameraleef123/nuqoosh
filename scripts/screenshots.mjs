...
const TEMPLATES = ['saqee', 'ballour', 'fajr', 'hibr', 'waraqa', 'badira', 'thurayya', 'rafif', 'siq', 'takwin', 'muheet', 'fayi', 'himma', 'mada', 'tesla', 'sakura', 'naseem', 'mashrabiya', 'newyork', 'alam', 'fann', 'majlis']
